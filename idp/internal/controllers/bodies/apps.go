...
type UpdateAppBody struct {
	...
	Providers      []string `json:"providers" validate:"required,oneof=email_password github google facebook apple microsoft"`
	IDTokenTtl     int32    `json:"id_token_ttl" validate:"required,gte=0,lte=2592000"` // 30 days
